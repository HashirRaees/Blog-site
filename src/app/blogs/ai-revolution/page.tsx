...
export default async function Ai(){
    let res = await client.fetch(`*[_type == "Blog1"]{
        title,
        body,
        image,
        date,
    ...
    return(
        <>
        <section className="sm:h-[1500px] h-[1500px] sm:w-[1349px] flex flex-col items-center">
            <div>
                {
                        ...
                        <div key={index}>
                            {/*Image*/}
                         {
                            ...
                            <div className="h-[200px] sm:h-[400px] sm:flex sm:justify-center sm:w-[800px] w-[340px] mt-10">
                               <Image src={urlFor(data.image).url()} alt="ai image" width={340} height={100} className="sm:w-[700px] sm:h-[400px]"/>
                            </div>
                         )
                         }
                            {/*Heading*/}
                            ...
                            {/*Text*/}
                            <div className="w-[340px] sm:w-[800px] text-center text-gray-700 sm:h-[550px] h-[820px]">
